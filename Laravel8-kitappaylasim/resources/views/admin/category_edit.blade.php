                ...
                <div class="card-body">
                   ...
                   <div style="width:200px; height: 800px;">
                       ...
                       <table>
                           ...
                           <tr><button type="submit" style="color:#95999c; background-color: #4a5568; width: 150px;" onclick="return confirm('Kategoriyi Güncellemek istediğinize emin misiniz?')">Kategoriyi Güncelle</button></tr>
                       </table>
                       </form>
                   </div>
